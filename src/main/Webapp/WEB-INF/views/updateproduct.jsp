...
<head>
	 <link rel="stylesheet" href="<c:url value="/resources/static/css/singup.css" />" />
</head>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-9 col-lg-8 mx-auto">
              <h3 class="login-heading display-4 text-center mb-4">Edit Product</h3>
              <form:form action="${pageContext.request.contextPath}/admin/product/edit/${productdetails.productId}" modelAttribute="productdetails" method="POST">
                ...
                <form:button class="btn btn-lg btn-block btn-primary text-white rounded-pill mb-2" type="submit">Update</form:button>
              </form:form>
            </div>
          </div>
        </div>
