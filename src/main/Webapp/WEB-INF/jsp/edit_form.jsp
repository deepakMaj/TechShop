...
<head>
	 ...
	 <sec:authorize access="!isAuthenticated()">
		<% response.sendRedirect("/?updateaccesserror"); %>
	</sec:authorize>
</head>
		 ...
		 <c:if test = "${not empty customererror}">
          ...
          <div class="row">
            <div class="col-md-9 col-lg-8 mx-auto">
              <h3 class="login-heading display-4 text-center mb-4">Edit</h3>
              <form:form action="edit_form" modelAttribute="customer" method="POST">
